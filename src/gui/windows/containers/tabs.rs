...
use crate::gui::utils::{clear_clipboard_files, clickable_icon, truncate_item_text, expand_environment_variables};
        ...
        if tab.breadcrumb_path_editing {
            ...
            if enter {
                ...
                if new_path.exists() {
                    ...
                    println!("Invalid path: {} (expanded to: {})", tab.breadcrumb_path_buffer, expanded_input);
